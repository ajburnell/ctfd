...
ansible_vault = subprocess.run(["ansible-vault", "encrypt_string", "--vault-password-file", "vault_password", service_password, "--name", "service_password", "--output", "host_vars/ctfd_vault.yml"])
